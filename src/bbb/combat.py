...
def resolve_battles(battles, board, players):
    ...
    for battle in battles:
        ...
        if str1 > str2:
            ...
            #     print(Fore.BLACK + Back.YELLOW + f"{battle.player1.coins} coins atm")
...
def correct_bets(battle):
    if battle.winner is None:
        ...
        # if (battle.player1.name == 'P1' or battle.player2.name == 'P1'):
...
def give_total_domination(player, board):
    ...
    # if player.name == 'P1':
    #     print(Back.CYAN + f"{second_max_bet} given to {player.name} atm: {player.front_coins}" + Style.RESET_ALL)
