...
TARGET_PLAYER = 'P1' # the player whose lines to highlight
FOCUS_ON_BET_SIZING = False # set to True to enable debug prints
FOCUS_ON_CARD_PLAY = True # set to True to enable debug prints
GAME_ENGINE_PIRINTS = True # set to True to enable debug prints